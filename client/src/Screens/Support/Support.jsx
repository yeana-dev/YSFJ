    ...
    <div className="support-container">
      <div className="support-left">
        ...
        <div className="support-content">
          Our goal is to ensure everyone is looking sleek with their new pairs!
          If you are not satisfied for any reason, please let us know! We can
          make it right. Please fill out this form, and we will get back to you
